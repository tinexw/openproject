...
module WorkPackageTypes
  class BaseTabController < ApplicationController
    ...
    # Configuration tabs address one variant. A path without one edits the type's base
    # variant, which is the configuration it uses where no other has been chosen.
    def find_variant
