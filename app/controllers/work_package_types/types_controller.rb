...
module WorkPackageTypes
  class TypesController < ApplicationController
    ...
    # The list renders each type with its variants, and each row reads the base variant's
    # workflows to warn about an unconfigured type, so both are preloaded here.
    def types_for_index
      ::Type
        .includes(:color, :projects,
                  default_variant: %i[own_workflows custom_fields],
