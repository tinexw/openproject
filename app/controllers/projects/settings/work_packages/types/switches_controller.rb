...
class Projects::Settings::WorkPackages::Types::SwitchesController < Projects::SettingsController
  ...
  # The row names the variant in force, so it is looked up globally and checked against the
  # types the project uses. It is then resolved again: on a page left open across a switch,
  # the id names a variant the project has since moved off.
  def load_source
