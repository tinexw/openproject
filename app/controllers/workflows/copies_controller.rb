...
class Workflows::CopiesController < ApplicationController
  ...
  # Only base variants are on offer until variants are switched on: a type has exactly one
  # configuration until then, and offering more would name configurations the rest of the
  # admin surface keeps hidden.
