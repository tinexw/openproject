...
module WorkPackageTypes
  module ConfigurationIndependence
    ...
    # variant's current settings. Confirming performs the switch with the chosen mode.
    class ConfirmDialogComponent < ApplicationComponent
      ...
      def switch_path
        type_configuration_independence_switch_path(type_id: variant.type_id, aspect:)
      end
    end
  end
end
