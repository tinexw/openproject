...
module WorkPackageTypes
  ...
  class ExclusionToggleComponent < ApplicationComponent
    ...
    # Exclusions or element_key being empty means the variant owns its configuration, so there is
    # nothing to render.
    def render?
    ...
    def toggle_path
      type_excluded_element_toggle_path(type_id: @exclusions.variant.id, aspect: @aspect, element: @element_key)
    end
  end
end
