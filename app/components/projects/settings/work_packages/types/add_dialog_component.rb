...
module Projects
  module Settings
    module WorkPackages
      module Types
        # Picks the variant a project should activate. Only types the project does not
        # already use are offered; swapping the variant of a type it does use is
        # FND-188's switch dialog.
        class AddDialogComponent < ApplicationComponent
          ...
          # A type is addable as a whole: every one of its variants is on offer until the
          # project uses one of them.
