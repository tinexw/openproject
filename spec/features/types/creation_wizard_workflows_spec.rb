...
RSpec.describe "Type creation wizard workflows step", :js, with_flag: { type_variants: true } do
  ...
  # These specs exercise the editable workflow step, so start from an Independent workflows
  # aspect. The linked-mode examples below establish a link explicitly.
