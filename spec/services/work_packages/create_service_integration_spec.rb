...
RSpec.describe WorkPackages::CreateService, "integration", type: :model do
  ...
  # The work package is created with the family's type, so the subject blueprint applied has to
  # be the one the project's variant resolves to, not the type's base.
